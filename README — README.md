...
-- UPDATE users SET is_admin = true WHERE email = 'your@email.com';# KnowNet X Backend + Scholarship Integration
...
https://github.com/Salmanferdousrafi/KnowNet-Backend-Scholarship-Integration
